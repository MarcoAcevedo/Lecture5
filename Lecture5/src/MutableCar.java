...
public class MutableCar {
	...
	//xPos yPos color horizontalSpeed horizontalDirection number constructor
	...
	public void draw(Graphics g) {
		...
		g2.setColor(Color.BLACK);
		g2.drawString((this.number+1)+"", Math.round(this.getXPos()+25),Math.round(this.getYPos()+20));
